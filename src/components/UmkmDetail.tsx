...
export default function UmkmDetail({ umkmId, onBack }: UmkmDetailProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* =====================================================
        DIV STICKY "KEMBALI" YANG SEBELUMNYA DI SINI, DIHAPUS
        =====================================================
      */}
      ...
      <div className="container mx-auto px-4 md:px-20 py-8">
        {/* ===============================================================
          TOMBOL "KEMBALI" DIPINDAHKAN KE SINI (DI DALAM CONTAINER)
          ===============================================================
        */}
        <div className="mb-6">
          {" "}
          {/* Tambahan margin bawah */}
          <button
            onClick={onBack}
            className="flex items-center gap-2 text-[#0B4EA2] hover:text-[#083d7f] transition-colors font-medium"
          >
            <ChevronLeft className="w-5 h-5" />
            Kembali ke Katalog {/* Teks diubah agar lebih jelas */}
          </button>
        </div>
