        ...
        <footer className="bg-[#002A6B] text-white py-12 md:py-16">
            <div className="container mx-auto px-6 md:px-12 lg:px-20">
                ...
                <div className="mb-8 md:mb-12">
                    ...
                    <p className="text-sm text-white/80 mt-2">Platform untuk menemukan dan mendukung UMKM lokal</p>
                </div>

                {/* Links Grid - Mobile: 2 columns, Desktop: 3 columns */}
                <div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12 mb-8 md:mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm md:text-base">
                            <li>
                                <a href="#beranda" onClick={(e) => handleClick(e, "#beranda")} className="hover:underline hover:text-[#FFC107] transition-colors">
                                    Beranda
                                </a>
                            </li>
                            <li>
                                <a href="#kategori" onClick={(e) => handleClick(e, "#kategori")} className="hover:underline hover:text-[#FFC107] transition-colors">
                                    Kategori
                                </a>
                            </li>
                            <li>
                                <a href="#lokasi" onClick={(e) => handleClick(e, "#lokasi")} className="hover:underline hover:text-[#FFC107] transition-colors">
                                    Lokasi
                                </a>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm md:text-base">
                            <li><a href="#" className="hover:underline hover:text-[#FFC107] transition-colors">Tentang Kami</a></li>
                            <li><a href="#" className="hover:underline hover:text-[#FFC107] transition-colors">Kontak</a></li>
                            <li><a href="#" className="hover:underline hover:text-[#FFC107] transition-colors">FAQ</a></li>
                        </ul>
                    </div>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-4 pt-8 border-t border-white/20">
                    <p className="text-xs md:text-sm text-center md:text-left text-white/80">
                        © {new Date().getFullYear()} UMKM Mamung. All rights reserved.
                    </p>
                    <div className="flex flex-col md:flex-row gap-4 md:gap-8 text-center">
                        <a href="#" className="text-xs md:text-sm hover:underline hover:text-[#FFC107] transition-colors">
                            Syarat & Ketentuan
                        </a>
                        <a href="#" className="text-xs md:text-sm hover:underline hover:text-[#FFC107] transition-colors">
                            Kebijakan Privasi
